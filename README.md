...
## - Registration Page
#### in this page, if user try to register with an email that is already registered it will says this email already exist please log in.
#### we also have validations that checks users input whether meet the requirements in registration
